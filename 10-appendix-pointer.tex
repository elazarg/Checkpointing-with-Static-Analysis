...
Key evaluation rules are shown in \autoref{fig:expr-semantics}. Note that the choice of Imm() is guided by the type system; Const() are just a special case where it is syntactically foced. 
