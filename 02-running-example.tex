...
K-Means clustering with $k$ clusters, implemented in Python using NumPy. \hspace{0.5em}To the right:\\
...
\emph{centroids}, where the $i$-th cluster consists of all points in $X$ that are closer to the $i$-th centroid than to all other centroids.
