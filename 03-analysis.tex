...
Python's method resolution (MRO) defines various rules governing the access of attributes.
...
respectively.
    \item \emph{Parameter objects} representing the main function's arguments that have been passed from its caller(s). (The callers themselves are not analyzed.)
    \item \emph{Allocation site objects} are summary objects representing a set of objects created at specific program locations. 
