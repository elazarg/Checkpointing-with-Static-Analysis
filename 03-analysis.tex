...
The pointer domain takes from the type information that subtraction is \tnew; allocates a fresh object \loc{34} at the call site; updates $S[\$5\smlmapsto\loc{34}]$; The heap $H$ is unchanged, since the type of the bound method at $\$7$ (\loc{33}) carries no \tupdate effect.
\end{example}
%
